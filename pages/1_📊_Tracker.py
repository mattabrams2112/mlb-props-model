...
from bet_config import (qualifies, qualifies_mask, bet_label,
                        EXPANSION_DATE, TIER2_MIN, TIER1_MIN, CAP_DATE, TIER2_END)
...
with _hdr:
    ...
    st.caption(f'Criteria: 85-89 = 1u · 95+ = 1u · Actuals fetched automatically')
    st.caption(f'📎 80-84 (0.5u) tracked **{EXPANSION_DATE} → {TIER2_END}** only, then dropped '
               f'(poor early results). 🚫 90-94 dropped from **{CAP_DATE}** (boom-or-bust; 95+ kept). '
